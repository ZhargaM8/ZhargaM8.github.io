function main(){
    ...
    var maxElementsVertices = gl.getParameter(gl.MAX_ELEMENTS_VERTICES); // Important
    var maxElementsIndices = gl.getParameter(gl.MAX_ELEMENTS_INDICES);   // Important
    console.log("Max vertices:", maxElementsVertices);
    console.log("Max indices:", maxElementsIndices);
